 ...
 * @author R
 */
public class gestiscieventi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Template t = c.getTemplate("gestiscieventi.ftl.html");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(gestiscieventi.class.getName()).log(Level.SEVERE, null, ex);
