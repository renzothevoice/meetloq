 ...
 * @author R
 */
public class add_invitati_event extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Template t = c.getTemplate("add_invitati_event.ftl.html");
        ...
        if(request.getSession(false)!=null){
            ...
            if(idtipo==2){
                data.put("tipo","2");//setta pannello organizzatore                 2
            }
            InvitatoDataLayer idl = dl.getInvitatoDataLayer(dl.getC());
            List <Invitato> invitati = new ArrayList();
            invitati = idl.getRubrica(idutente);
            data.put("invitati",invitati);
            dl.getC().close();
        }
        try {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(add_invitati_event.class.getName()).log(Level.SEVERE, null, ex);
