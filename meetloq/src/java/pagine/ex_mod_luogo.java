 ...
 * @author R
 */
public class ex_mod_luogo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(nome.isEmpty() || indirizzo.isEmpty() || tipoluogo.isEmpty() || posti==0){
              ...
              response.sendRedirect("mod_luogo?idluogo="+idluogo+"&msg=CI SONO CAMPI VUOTI!!");   
            }else{
                ...
                Luogo tmp=new LuogoImpl(idluogo,nome,indirizzo,null,null,tipoluogo,posti);
                ldl.updateLuogo(tmp);
                attdl.deleteAttrezzaturabyluogo(idluogo);
                for(int i=0;i<n;i++)
                {
               ...
               response.sendRedirect("mod_luogo?idluogo="+idluogo+"&msg=IL LUOGO E' STATO AGGIORNATO!!");
            }
